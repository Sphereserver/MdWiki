...
On X version: CAN flags are read only. You can't edit them after the item/char creation. I you want modify the can Flags you should use [CANMASK](CANMASK "wikilink")

# Usage

 \[itemdef i_test\] id=i_pickaxe name=Pickaxe can=can_i_flip\|can_i_dye\|can_i_repair //This is how values must be added, using the \| means they are being sum.
...
CAN_I_PLATFORM 000004 // we can walk on top of it. (even tho the itemitself might block) UFLAG2_PLATFORM
