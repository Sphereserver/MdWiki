...
| ------------ | -------------- | ----------------------------------------------------------- | --------------- |
| ARGN1 | I | The button command type. Known values are: <table> **Type** | **Description** |
| 1 | Cast spell |  |  |
| 2 | Weapon ability |  |  |
| 3 | Use skill |  |  |
| 4 | Use item |  |  |
| 5 | Scroll |  |  |</td>
</tr> <tr> <td><p>ARGN2</p></td> <td><p>I</p></td> <td><p>The button's command parameter.</p></td> </tr> </tbody> </table>
