...
The trigger is fired based on the Attacker list, @Death is called before
it and @DeathCorpse after, so the @Death trigger can pre-handle who will
receive this trigger by adding or removing attackers.
