...
| LOCAL.DamageType | IO | Can be used to override the damage flags for spells that have SPELLFLAG_DAMAGE. The value can be a bitmask of dam_* flags. For example, to change the s_magic_arrow SPELL definition to cause physical and magic damage: `ON=@Effect` `LOCAL.DAMAGETYPE=(&lt;DEF.dam_physical&gt;\|&lt;DEF.dam_magic&gt;)` |
