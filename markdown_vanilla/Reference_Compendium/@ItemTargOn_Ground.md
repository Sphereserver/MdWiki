...
| **Name** | **Description** |
| --- | --- |
| [ACT](ACT) | The [item](Items) that the target cursor originated from. |
| [I](I) | The [player](Characters#Players) targeting the ground. **Note:** The [TARGP](TARGP) property on the player can be used to acquire the target coordinates. |
