...
| E](./ADV_RATE.md) |                | skill\'s advance rate.  |
|                         |                | Accepts multiple values |
|                         |                | to adjust based on      |
|                         |                | skill level.            |
+-------------------------+----------------+-------------------------+
| [BONUS_DEX              | RW             | Gets or sets a          |
| ](./BONUS_DEX.md) |                | multiplier for how much |
|                         |                | dexterity affects a     |
...
| ](./BONUS_INT.md) |                | multiplier for how much |
|                         |                | intelligence affects a  |
|                         |                | character\'s non-real   |
|                         |                | skill amount, and       |
|                         |                | affects stat gain.      |
+-------------------------+----------------+-------------------------+
| [BONUS_STATS](./RW______________Gets_or_sets_a_modifier_
_BONUS_STATS.md) |                | for gaining stats when  |
|                         |                | using the skill.        |
+-------------------------+----------------+-------------------------+
| [BONUS_STR              | RW             | Gets or sets a          |
| ](./BONUS_STR.md) |                | multiplier for how much |
|                         |                | strength affects a      |
|                         |                | character\'s non-real   |
|                         |                | skill amount, and       |
|                         |                | affects stat gain.      |
...
| ELAY](./DELAY.md) |                | it takes to attempt to  |
...
| ECT](./EFFECT.md) |                | which effects skills in |
|                         |                | different ways.         |
|                         |                | (Crafting = Resource    |
...
| ROUP](./GROUP.md) |                | skill\'s group flags.   |
+-------------------------+----------------+-------------------------+
| [KEY](./KEY.md)   | RW             | Gets or sets the        |
|                         |                | skill\'s defname.       |
+-------------------------+----------------+-------------------------+
| [NAME](./NAME.md) | RW             | Gets or sets the name   |
|                         |                | of the skill.           |
+-------------------------+----------------+-------------------------+
| [STAT_DE                | RW             | Gets or sets the        |
| X](./STAT_DEX.md) |                | maximum dexterity a     |
|                         |                | character can gain up   |
|                         |                | to when using this      |
|                         |                | skill.                  |
+-------------------------+----------------+-------------------------+
| [STAT_IN                | RW             | Gets or sets the        |
| T](./STAT_INT.md) |                | maximum intelligence a  |
|                         |                | character can gain up   |
|                         |                | to when using this      |
|                         |                | skill.                  |
+-------------------------+----------------+-------------------------+
| [STAT_ST                | RW             | Gets or sets the        |
| R](./STAT_STR.md) |                | maximum strength a      |
|                         |                | character can gain up   |
|                         |                | to when using this      |
|                         |                | skill.                  |
+-------------------------+----------------+-------------------------+
...
| ITLE](./TITLE.md) |                | professional title for  |
|                         |                | the skill.              |
+-------------------------+----------------+-------------------------+
| [VAL                    | RW             | Gets or sets a modifier |
| UES](./VALUES.md) |                | for the value of items  |
...
trigger on the [character](./Characters.md) object.
  ...
  ------------------------------------ -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  **Name**                             **Description**
  [\@Abort](./Abort.md)         Fires when a character aborts an attempt at using the skill.
  [\@Fail](./Fail.md)           Fires when a character fails an attempt at using the skill.
  [\@Gain](./Gain.md)           Fires when a character is given the chance to gain in the skill.
  [\@PreStart](./PreStart.md)   Fires when a character starts to use the skill, before any hardcoded behaviour takes place.
  [\@Select](./Select.md)       Fires when a character selects the skill from their skill menu.
  [\@Start](./Start.md)         Fires when a character starts to use the skill.
  [\@Success](./Success.md)     Fires when a character succeeds an attempt at using the skill.
  [\@UseQuick](./UseQuick.md)   Fires when a character quickly uses the skill, without changing their [ACTION](./ACTION.md).
  [\@Wait](./Wait.md)           This is called whenever Sphere wants to check if a character must wait before starting a skill. Normally this will be when a skill is selected from the skill menu (before [\@Select](./Select.md)), but also when snooping a container or using a musical instrument.
  ------------------------------------ -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
