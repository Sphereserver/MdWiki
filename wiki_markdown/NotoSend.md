...
|----|----|
| **Name** | **Description** |
| [I](./I.md) | The [character](./Characters.md) whose noto is changing. |
| [SRC](./SRC.md) | The [character](./Characters.md) retrieving this character's Notoriety. |
...
| ARGN1 | IO | The notoriety value. By default limited from 1 to 7, but this can be overridden to create custom notoriety feelings. |
...
- The trigger will no longer check if ARGN1 > NOTO_INVUL, allowing for the creation of custom notoriety.
