...
- `ACTARG3` is set to 1 in the `@Start` trigger for Provocation if the provoked character is in the same ally group as the targeted character, otherwise it's 0. This allows for overriding the hardcoded behavior of the Provocation skill.
