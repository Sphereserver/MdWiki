...
[server](./Server.md) object. The following table details the
...
usage and examples.
  ...
  **Name**                        **Read/Write**   **Description**
  [ACCOUNT](./ACCOUNT.md)   R                Gets the name of the account that sent the page.
  [HANDLED](./HANDLED.md)   R                Gets the [UID](./UID.md) of the character currently handling the page.
  [P](./P.md)               RW               Gets or sets the location that the page was sent from.
  [REASON](./REASON.md)     RW               Gets or sets the reason for the page.
  [STATUS](./STATUS.md)     R                Gets the status of the page sender (OFFLINE, LOGIN or character name).
  [TIME](./TIME.md)         RW               Gets the time since the page was originally sent in seconds.
  ------------------------------- ---------------- ------------------------------------------------------------------------------
