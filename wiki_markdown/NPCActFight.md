...
+--------------+------------+----------------------------------------+
| ARGN1        | IO         | The distance between the NPC and its   |
|              |            | target.                                |
+--------------+------------+----------------------------------------+
| ARGN2        | IO         | The NPC\'s motivation level to fight.\ |
|              |            | **Note:** NPCs, excluding pets, with a |
|              |            | motivation less than zero will flee    |
|              |            | from their target.                     |
+--------------+------------+----------------------------------------+
| local.Skill  | O          | Force the NPC to stop current checks   |
|              |            | and start this skill.                  |
+--------------+------------+----------------------------------------+
| local.Spell  | O          | Force to cast an specific spell in     |
|              |            | case LOCAL.SKILL is set to a SKF_MAGIC |
|              |            | skill.                                 |
+--------------+------------+----------------------------------------+
