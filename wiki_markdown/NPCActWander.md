...
+--------------+------------+----------------------------------------+
| ARGN1        | IO         | 0 if it will continue to wander, 1 if  |
|              |            | randomly deciding to stop, 2 if        |
|              |            | deciding to stop because               |
|              |            |                                        |
|              |            | `   after looking a                    |
|              |            | round it found something interesting.` |
+--------------+------------+----------------------------------------+
| ARGN2        | IO         | 1 if it\'s returning to home, 0        |
|              |            | otherwise.                             |
+--------------+------------+----------------------------------------+
