...
| N](./PIN.md)*.n*\ |                | the *nth* pin           |
| [PIN](./PIN.md)   |                | (zero-based), or adds a |
| *x, y*                  |                | pin to the map at the   |
|                         |                | specified location.     |
+-------------------------+----------------+-------------------------+
| [MORE1H](./RW______________Gets_the_top_left_______
_MORE1H.md),[MOR |                | coordinates (x,y) of    |
| E1L](./MORE1L.md) |                | the area displayed on   |
|                         |                | t_map.                  |
+-------------------------+----------------+-------------------------+
| [MORE2H](./RW______________Gets_the_bottom_right___
_MORE2H.md),[MOR |                | coordinates (x,y) of    |
| E2L](./MORE2L.md) |                | the area displayed on   |
|                         |                | t_map.                  |
+-------------------------+----------------+-------------------------+
...
STR property exists on the [character](./Characters.md)).
...
[RESOURCES](./RESOURCES.md) property, it is considered a
