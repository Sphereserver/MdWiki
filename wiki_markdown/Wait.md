...
[\@SkillWait](@SkillWait "wikilink") exists for characters). This
trigger is called whenever Sphere wants to check if a character must
wait before starting a skill. Normally this will be when a skill is
selected from the skill menu (before [\@Select](@Select "wikilink")),
