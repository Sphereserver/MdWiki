...
|----|----|
| **Name** | **Description** |
| [ARGO](./ARGO.md) | The [character](./Characters.md) whose virtue dialog is being requested. |
| [I](./I.md) | The [client](./CharactersClients.md) attempting to access or use the virtue dialog. |
| [SRC](./SRC.md) | The [client](./CharactersClients.md) attempting to access or use the virtue dialog. |
