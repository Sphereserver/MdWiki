...
`<spherescript>`{=html}local.success = \<eval `<MaxHits>`{=html}\*16\>
...
Here\'s a damage formula to force damage: `<spherescript>`{=html}
damage=\<eval `<maxhits>`{=html}\*16\>,`<src>`{=html},dam_physical
`</spherescript>`{=html}
