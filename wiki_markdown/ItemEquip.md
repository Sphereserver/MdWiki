...
|                  | **Note:** This trigger is not reliable for       |
|                  | blocking the equipping of an item. Use the       |
|                  | [\@EquipTest](@EquipTest "wikilink") trigger     |
|                  | instead which is designed for blocking the equip |
|                  | action.                                          |
+------------------+--------------------------------------------------+
