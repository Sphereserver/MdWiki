...
This trigger fires when a multi is about to redeed. Valid for t_multi,
t_ship, t_multi_custom and t_addon.
...
|----|----|
| **Name** | **Description** |
| [ARGO](./ARGO.md) | The deed |
| [I](./I.md) | The multi |
| [SRC](./SRC.md) | Player doing the redeed (If Any). When the multi is being removed there is no SRC (also when an Addon is being redeeded from internal functions). |
