...
|                     |            | Coin.                           |
+---------------------+------------+---------------------------------+
| local.Duration      | IO         | Overrides the default duration  |
|                     |            | of spell in tenths of second    |
|                     |            | (local.duration = 10 is 1       |
|                     |            | second).                        |
+---------------------+------------+---------------------------------+
| local.Effect        | IO         | Changes the EFFECT value of the |
|                     |            | spell (For changing EFFECT_ID   |
|                     |            | see Local.CreateObject1).       |
+---------------------+------------+---------------------------------+
