...
trigger:
  ...
  ------------------- ----------------------------
  **Name**            **Description**
  [I](I "wikilink")   The multi about to design.
  ------------------- ----------------------------
...
+------------------+--------------------------------------------------+
| 1                | Forces the char to exit Customize mode.          |
|                  |                                                  |
|                  | `   WA                                           |
|                  | RNING: Forcing the char to exit here and setting |
|                  |  argn1=0 in @HouseDesignExit will make it enter  |
|                  | in customize mode, exit, enter... infinitelly, h |
|                  | ence crashing the server with an infinite loop.` |
+------------------+--------------------------------------------------+
