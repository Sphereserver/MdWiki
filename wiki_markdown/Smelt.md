...
This trigger is fired when an item is being smelt nearby a forge or by
using the SMELT command.
...
|-----------------------|-----------------------------------|
| **Name**              | **Description**                   |
| [I](./I.md)     | The item being smelt.             |
| [SRC](./SRC.md) | The character smelting the item.. |
