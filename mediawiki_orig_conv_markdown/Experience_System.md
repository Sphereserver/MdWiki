...
### Experience in Combat {#experience_in_combat}
...
-   You will get between 1 and 20 percent of your enemy\'s EXP as
    experience; if you\'re a newbie fighting a very experienced enemy
    with success, you\'ll gain much more EXP than he would gain if he
    slays you.
-   If there are more but one persons involved in the fight, everyone
    gets a share.
...
-   If you\'ve activated Sphere\'s level system the level difference
    between you and your victim will also influence the amount of EXP
    you\'ll gain.
...
-   If not set explicitely set by script, monsters\' EXP are calculated
    ...
    its base defense and attack damage values. Just to give a relation:
    An orc will have approx. 650 EXP, a daemon will have approx. 7 times
    the EXP of an orc.

### Experience in Crafting {#experience_in_crafting}

-   You will only get EXP by crafting items that have a value.
-   You will gain approximately 1 percent of the value of an item as
    EXP.
...
-   Levelling only means that the LEVEL property rises. It also means
    that the EXP \_given\_ by a slain character will grow with its
    LEVEL, and that the EXP the killer receives will go down with *his*
    LEVEL.
...
+----------------------+-----------------+-----------------+
| **LEVEL**\           | **EXP Needed**\ | **EXP Needed**\ |
| *(LevelNextAt=1000)* | *(LevelMode=0)* | *(LevelMode=1)* |
+----------------------+-----------------+-----------------+
| 1                    | 1000            | 1000            |
+----------------------+-----------------+-----------------+
| 2                    | 2000            | 3000            |
