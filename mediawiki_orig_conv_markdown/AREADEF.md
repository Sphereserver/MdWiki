...
`<spherescript>`{=html} // // The world region from the default script
pack. // \[AREADEF a_world\]
...
`<spherescript>`{=html} // // Lord British\'s Castle from the default
script pack. // \[AREADEF a_lord_britishs_castle_1\]
EVENTS=r_default,r_default_rock,r_default_water,r_default_tree,r_default_grass
