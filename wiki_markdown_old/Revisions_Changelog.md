\_\_FORCETOC\_\_ Following is a list of all changes made to Sphere since
version 55a. These changes can also be found by opening and reading the
REVISIONS-55-SERIES.txt and REVISIONS-56-SERIES.txt files that are
provided with the Sphere download.

You can also retrieve the very latest revisions file for the 56 series
from the [Automated SVN
Builds](http://nightly.prerelease.sphere.torfo.org/files/revisions.txt)
page. This file also shows the changes that have been made for the next
prerelease.

## REVISIONS-55-SERIES {#revisions_55_series}
...
## REVISIONS-56-SERIES {#revisions_56_series}
...
## 0.56d, Current Nightly {#d_current_nightly}
