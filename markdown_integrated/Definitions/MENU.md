...
```
 ...
 // // Displays a menu asking if the player wants more gold, and creates it // if they select Yes. // \[MENU m_goldmenu\] You currently have \<SRC.BANKBALANCE\>gp in your account. Would you like some more gold?
...
`   RETURN`
 ...
 // // Displays a menu asking the player which item they would like. // \[MENU m_itemmenu\] Which item would you like?
...
`   RETURN`
 ...
 // // Demonstrates the @Cancel trigger // \[MENU m_cancelmenu\] Don't cancel this menu!
