...
When the client selects an option from the menu, the "ON=*...*" section
will be executed, in a similar fashion to how a trigger would fire.
...
<spherescript> // // Displays a menu asking if the player wants more
gold, and creates it // if they select Yes. // \[MENU m_goldmenu\] You
currently have \<SRC.BANKBALANCE\>gp in your account. Would you like
some more gold?
...
<spherescript> // // Displays a menu asking the player which item they
would like. // \[MENU m_itemmenu\] Which item would you like?
...
<spherescript> // // Demonstrates the @Cancel trigger // \[MENU
m_cancelmenu\] Don't cancel this menu!
