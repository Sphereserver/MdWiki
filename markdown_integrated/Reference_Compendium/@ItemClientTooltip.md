...
This trigger fires when tooltips for an item are about to be sent to a client. the [ADDCLILOC](ADDCLILOC "wikilink") function can be called on the [I](I "wikilink") object to send custom tooltips to the client.
...
|----|----|
| **Name** | **Description** |
| [ACT](ACT "wikilink") | The [item](Items "wikilink") whose tooltips are to be sent. |
