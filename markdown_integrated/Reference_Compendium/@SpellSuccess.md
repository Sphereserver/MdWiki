...
| LOCAL.CREATEOBJECT1 | O | For field spells, overrides the item [BASEID](BASEID) to use for the east-west direction. For summon spells, overrides the character [BASEID](BASEID) to summon. |
| LOCAL.CREATEOBJECT2 | O | For field spells, overrides the item [BASEID](BASEID) to use for the north-south direction. |
