...
| **SERV.**[LIST](LIST "wikilink").*xxx*.ADD *<args>* | W | Adds *<args>* as a new element in LIST.*xxx* |
| **SERV.**[LIST](LIST "wikilink").*xxx*.APPEND *<args>,...* | W | Sets each *<args>* as a new element in LIST.*xxx* |
| **SERV.**[LIST](LIST "wikilink").*xxx*.CLEAR | W | Clears LIST.*xxx* |
| **SERV.**[LIST](LIST "wikilink").*xxx*.SET *<args>,...* | W | Clears the list and sets each *<args>* as a new element in LIST.*xxx* |
| **SERV.**[LIST](LIST "wikilink").*xxx*.SORT *<args>* | W | Re-orders LIST.*xxx* according to *<args>*. (possible values are: *no args* , *i* , *asc* , *iasc* , *desc* , *idesc*) |
...
| **SERV.**[LIST](LIST "wikilink").*xxx*.*n*.INSERT *<args>* | W | Inserts *<args>* at the *nth* index of LIST.*xxx* |
| **SERV.**[LIST](LIST "wikilink").*xxx*.FINDELEM *<args>* | W | Searches LIST.*xxx* for *<args>* starting from the beginning of LIST.*xxx* |
| **SERV.**[LIST](LIST "wikilink").*xxx*.*n*.FINDELEM *<args>* | W | Searches LIST.*xxx* for *<args>* starting from the *nth* index of LIST.*xxx* |
