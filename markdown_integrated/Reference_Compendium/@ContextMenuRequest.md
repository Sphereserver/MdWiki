...
This trigger fires when a character attempts to access the context menu on an object. The [ADDCONTEXTENTRY](ADDCONTEXTENTRY "wikilink") function can be called on SRC to add custom menu entries to the menu.
