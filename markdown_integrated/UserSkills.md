...
receive a skill gain. It can also fire when the [INFO](./INFO.md)
command is used.
...
|----|----|
| **Name** | **Description** |
| [I](./I.md) | The [client](./CharactersClients.md) receiving the skill update. |
| [SRC](./SRC.md) | The [character](./Characters.md) whose skill(s) they are receiving. |
...
| ARGN2 | I | If 1, then the skills update is being sent due to the [INFO](./INFO.md) command being used. |
