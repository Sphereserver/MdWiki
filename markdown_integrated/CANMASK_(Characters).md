...
X branch only. This property is a bitmask, like the CAN property, and stores the [CAN (Characters)](CAN_(Characters) "wikilink") flags to be dynamically switched on or off from the base CAN property.
