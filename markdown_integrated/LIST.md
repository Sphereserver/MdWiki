...
| **SERV.**[LIST](./LIST.md).*xxx* | R | Shows elements in LIST.*xxx* |
| **SERV.**[LIST](./LIST.md).*xxx*.ADD *<args>* | W | Adds *<args>* as a new element in LIST.*xxx* |
| **SERV.**[LIST](./LIST.md).*xxx*.APPEND *<args>,...* | W | Sets each *<args>* as a new element in LIST.*xxx* |
| **SERV.**[LIST](./LIST.md).*xxx*.CLEAR | W | Clears LIST.*xxx* |
| **SERV.**[LIST](./LIST.md).*xxx*.SET *<args>,...* | W | Clears the list and sets each *<args>* as a new element in LIST.*xxx* |
| **SERV.**[LIST](./LIST.md).*xxx*.SORT *<args>* | W | Re-orders LIST.*xxx* according to *<args>*. (possible values are: *no args* , *i* , *asc* , *iasc* , *desc* , *idesc*) |
| **SERV.**[LIST](./LIST.md).*xxx*.*n* | R | References the *nth* zero based index of the LIST.*xxx* |
| **SERV.**[LIST](./LIST.md).*xxx*.COUNT | R | Gets the total number of elements in LIST.*xxx* |
| **SERV.**[LIST](./LIST.md).*xxx*.*n*.REMOVE | W | Removes the *nth* element in LIST.*xxx* |
| **SERV.**[LIST](./LIST.md).*xxx*.*n*.INSERT *<args>* | W | Inserts *<args>* at the *nth* index of LIST.*xxx* |
| **SERV.**[LIST](./LIST.md).*xxx*.FINDELEM *<args>* | W | Searches LIST.*xxx* for *<args>* starting from the beginning of LIST.*xxx* |
| **SERV.**[LIST](./LIST.md).*xxx*.*n*.FINDELEM *<args>* | W | Searches LIST.*xxx* for *<args>* starting from the *nth* index of LIST.*xxx* |
