The script below is in no way complete, all it does at the moment is retransmit what the player said (from the player's point of view nothinghappened). It is up to you to add what you want to the script and make it work the way you want to.
...
\[FUNCTION capture_speach\] REF1 = <UID>
...
```
// Get hearing distance based on speech mode IF (\<LOCAL.MODE\> ==talkmode_system)
```
